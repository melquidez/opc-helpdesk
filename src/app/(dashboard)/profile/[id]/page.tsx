    ...
    return (
        ...
        <div className="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div className="flex flex-col items-center -mt-20">
                <Image
                    src={`https://ui-avatars.com/api/?size=1080&background=0D8ABC&color=fff&name=${userProfile.username == 'admin' ? 'Administrator' : userProfile.username}`}
                    width={90}
                    height={90}
                    alt="User Profile"
                    className="w-40 border-4 border-white rounded-full"/ >
                <div className="flex items-center space-x-2 mt-2">
                    <p className="text-2xl">{userProfile.first_name + ' ' + userProfile.last_name}</p>
                </div>
                ...
                <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul className="mt-2 text-gray-700">
                        <li className="flex border-y py-2">
                            ...
                            <span className="text-gray-700">{userProfile.username}</span>
                        </li>
                        <li className="flex border-y py-2">
                            <span className="font-bold w-24">Full name:</span>
                            <span className="text-gray-700">{userProfile.first_name + ' ' + userProfile.last_name}</span>
                        </li>
